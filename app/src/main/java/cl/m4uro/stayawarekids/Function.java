...
public class Function {
    ...
    private static final String OPEN_WEATHER_MAP_API = "d960471b2be2c44b1c5266f7f39b99f3";
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    if (main.getDouble("temp")>25) {
                        new GetMethodDemo().execute("ignacio.awaresystems.cl/insertarAlertaAdulto.php?intentoAlerta=1&estadoAlerta=1&Usuario_id_usuario=12&tipoAlerta=AltaTemperatura");
                    }
