...
//Este es el grafico que se muestra de Temperatura vs Humedad
public class CharActivity extends AppCompatActivity {
    ...
    private class ReadJSON extends AsyncTask<java.net.URL, Void, String> {    //Tarea asíncrona para leer JSON

        protected String doInBackground(java.net.URL... urls) {
            java.net.URL url = urls[0];
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    if (!row.getString("_id").equals("0")){
                        ...
                        if (ExisteT && ExisteH ){
                            ...
                            System.out.println(iTemperatura+"temperatura");
                            System.out.println(iHumedad+"humedad");
    ...
    public String readJSONFeed(java.net.URL url) {       //Descarga los datos JSON
    ...
    private class DownloadFilesTaskUsuario extends AsyncTask<java.net.URL, Integer, String> {    //Realiza la conexión y retorna el usuario
        protected String doInBackground(java.net.URL... urls) {
            java.net.URL url = urls[0];
