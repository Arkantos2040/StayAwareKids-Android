            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    for(int i=0;i < obj.length();i++){
                        ...
                        imagenUrl= new URL("http://ignacio.awaresystems.cl/"+nombre+"%20"+ apellido+"/"+nombre+"%20"+apellido+"_foto1.jpg");
                    ...
                    imagenUrl= new URL("http://ignacio.awaresystems.cl/"+nombre+"%20"+ apellido+"/"+nombre+"%20"+apellido+"_foto2.jpg");
                    conn = (HttpURLConnection) imagenUrl.openConnection();
                    conn.connect();
                    ...
                    imagenUrl= new URL("http://ignacio.awaresystems.cl/"+nombre+"%20"+ apellido+"/"+nombre+"%20"+apellido+"_foto3.jpg");
                    conn = (HttpURLConnection) imagenUrl.openConnection();
                    conn.connect();
                    ...
                    imagenUrl= new URL("http://ignacio.awaresystems.cl/"+nombre+"%20"+ apellido+"/"+nombre+"%20"+apellido+"_foto4.jpg");
                    conn = (HttpURLConnection) imagenUrl.openConnection();
                    conn.connect();
