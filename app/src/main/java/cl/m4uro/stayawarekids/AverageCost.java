...
// Parte de consumo de Efficient home donde no va en el proyecto donde trate de sacarlo pero no pude
public class AverageCost {
    private String ip, fechamin, fechamax;
    private ScrollingConsumptionActivity consumo;

    public AverageCost(ScrollingConsumptionActivity consumo, String ip, String fechamin, String fechamax) {
