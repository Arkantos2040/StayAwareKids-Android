 ...
 */
//Eliminar sensores de la parte de configuraciones
public class LocationAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final TextView listItemText = (TextView)view.findViewById(R.id.txtUbicacion);
        ...
        listItemText.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                String[] separa = listItemText.getText().toString().split("-");
                Intent intent = new Intent(context, ScrollingLocationActivity.class);
                intent.putExtra("opcion",2);
                intent.putExtra("codigo", Integer.parseInt(separa[0].trim()));
